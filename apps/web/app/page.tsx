...
const SOCIAL_PROOF = [
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1540569014015-19a7be504e3a?w=400&h=400&fit=crop&crop=face',
  },
  {
    name: 'Marcus Johnson',
    title: 'Apex Roofing',
    ...
    <main className="bg-[var(--nm-white)] text-[var(--nm-black)]">
      <header className="border-b border-[var(--nm-border)]">
        <div className="landing-container h-16 flex items-center justify-between">
          <span className="text-sm font-semibold tracking-tight text-[var(--nm-black)]" style={{ border: 'none' }}>NeverMiss</span>
